...
from servergrimoire.djangocheck import single_django_checker
from servergrimoire.ssl_stuff import ssh_status
...
class SSLData:
    def __init__(
        ...
        buffer: int = 30,
        ssl: bool = False,
        ssl_last_check: datetime.datetime = None,
...
class EndpointChecker:
    def __init__(
        ...
        hostname: str,
        path: str = "/life",
        message_out: dict = {"status": "alive and kicking"},
        endpoint_check: bool = False,
    ...
    def check(self):
        self.endpoint_check, _, _, self.last_status = single_django_checker(
            self.hostname, self.path, self.message_out
        )
...
class Server:
    def __init__(
        self, hostname, buffer: int = 30, endpoint_check: EndpointChecker = None
    ):
        self.hostname = hostname
